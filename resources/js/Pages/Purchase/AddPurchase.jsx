            ...
            <form onSubmit={submit}>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="lg:col-span-1 space-y-4">
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-2">
                                        ...
                                        {brands.map(brand => (
                                            <button
                                                ...
                                                className={`btn btn-xs rounded-lg ${selectedBrand === brand ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-700'}`}
                                            >
                                                {brand}
                                            </button>
                                        ))}
                        ...
                        {/* Payment Info Card */}
                        {!isShadowUser && (
                            <div className="card card-compact bg-gray-900 border border-gray-800 rounded-2xl text-white shadow-lg">
                                <div className="card-body">
