        ...
        <div className={`p-6 bg-[#f8f9fa] min-h-screen ${locale === 'bn' ? 'bangla-font' : ''}`}>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <button 
                    ...
                    className="btn bg-gray-900 hover:bg-red-600 text-white border-none rounded-xl px-8 font-black uppercase text-xs tracking-widest shadow-xl"
                >
                    ...
                    {todaysExpense.data.length > 0 ? (
                        <div className="overflow-x-auto rounded-2xl border border-gray-200">
                            <table className="table w-full">
                                <thead className={`${isShadowUser ? 'bg-yellow-600' : 'bg-gray-900'} text-white`}>
                                    <tr>
                                    ...
                                    {todaysExpense.data.map((expense, index) => {
                                        ...
                                        return (
                                            <tr key={index} className="hover:bg-gray-50 border-b border-gray-100">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className="badge bg-gray-900 text-white border-none text-xs font-bold uppercase py-2 px-4">
                                                        {expense.date}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">
                        ...
                        <div className="border-4 border-dashed border-gray-300 rounded-2xl px-8 py-16 flex flex-col justify-center items-center gap-4 text-center">
                            ...
                            <button
                                onClick={() => setModel(true)}
                                className="btn bg-gray-900 hover:bg-red-600 text-white border-none rounded-xl px-8 font-black uppercase text-xs tracking-widest shadow-xl mt-4"
                            >
                ...
                <div className="modal-box max-w-2xl rounded-2xl border-4 border-gray-900 p-0 overflow-auto shadow-2xl">
                    ...
                    <form onSubmit={formSubmit} className="p-6 space-y-6">
                        ...
                        <div className="flex justify-between items-center pt-6 border-t border-gray-200">
                            ...
                            <button
                                disabled={processing}
                                className="btn bg-gray-900 hover:bg-red-600 text-white border-none rounded-xl font-black uppercase text-[10px] tracking-widest px-8 shadow-xl"
                                type="submit"
                            >
                                {processing ? (
                                    <>
