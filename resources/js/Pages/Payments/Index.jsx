    ...
    return (
        <div className={`bg-white rounded-box p-5 ${locale === 'bn' ? 'bangla-font' : ''}`}>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    <div className="flex bg-gray-100 rounded-xl p-1 shadow-inner border border-gray-200">
                        ...
                        <button
                            ...
                            className="btn btn-sm bg-gray-900 hover:bg-red-600 text-white border-none rounded-lg"
                        >
                            <Search size={14} />
                        </button>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
                <div className="bg-gray-900 rounded-2xl p-4 shadow-xl border-b-4 border-red-600 text-white">
