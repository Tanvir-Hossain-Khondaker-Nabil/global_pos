  ...
  const handleBulkBarcodePrint = () => {
    ...
    const css = `
      ...
      * { box-sizing:border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
      ...
      .sheet { width:100%; display:flex; justify-content:${align === "right" ? "flex-end" : "flex-start"}; }
      .grid {
        display:grid;
      ...
      .barcodeImg { width:100%; height:${Number(barcodeImgHeightPx)}px; object-fit:contain; display:block; }
