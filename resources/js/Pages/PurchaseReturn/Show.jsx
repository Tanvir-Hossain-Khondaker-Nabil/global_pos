            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center gap-3">
                        <Link
                            href={route('purchase-returns.list')}
                        ...
                        {returnItem.status === 'pending' && (
                            <>
                                {/* <Link
                                    href={route('purchase-returns.edit', returnItem.id)}
                                ...
                                <Link
                                    href={route('purchase-returns.destroy', returnItem.id)}
                                    method="delete"
                                    as="button"
                        ...
                        <div className="card bg-base-100 border border-base-300">
                            <div className="card-body">
                                ...
                                <div className="mt-6 pt-6 border-t border-base-300">
                                    {returnItem.status === 'pending' && (
                                        <Link
                                            href={route('purchase-returns.approve', returnItem.id)}
                                            method="post"
                                            as="button"
                                    ...
                                    {returnItem.status === 'approved' && (
                                        <Link
                                            href={route('purchase-returns.complete', returnItem.id)}
                                            method="post"
                                            as="button"
