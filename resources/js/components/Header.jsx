                ...
                {showOutletDropdown && (
                  <div className="absolute left-0 mt-2 w-[290px] sm:w-[320px] bg-white rounded-2xl shadow-2xl border border-black/5 z-[60] overflow-hidden">
                    <div className="p-4 border-b">
                      ...
                      {/* Show current header settings if available */}
                      {headerSettings && (
                        <div className="mt-3 pt-3 border-t border-gray-100">
                          <div className="text-[11px] font-bold text-gray-500 uppercase">Header Settings</div>
                          <div className="text-xs text-gray-700 mt-1">
                            Title: <span className="font-medium">{headerSettings.title}</span>
                          </div>
                          <div className="text-xs text-gray-700">
                            Sidebar: <span className="font-medium">{headerSettings.sitebar_name}</span>
                          </div>
                          <Link
                            href={route('headers.edit', headerSettings.outlet_id)}
                    ...
                    <div className="p-2 border-t">
                      <div className="grid grid-cols-1 gap-2">
                        {/* <Link
                          ...
                          className="px-3 py-2 rounded-xl hover:bg-gray-50 transition flex items-center gap-2 text-gray-700 font-medium text-sm"
                          onClick={() => setShowOutletDropdown(false)}
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-2 rounded-xl hover:bg-red-50 transition flex items-center gap-2 text-red-600 font-semibold text-sm"
                        >
                          <LogOut size={16} />
                          Logout from Outlet
                        </button>
