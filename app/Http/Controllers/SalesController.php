...
class SalesController extends Controller
{
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        if ($adjust_amount == true && $request->customer_id) {
        ...
        try {
            ...
            // Process regular items from inventory
            ...
            // Calculate shadow amounts (if needed)
